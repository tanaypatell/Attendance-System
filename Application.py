...
from GenderPrediction import emotion,ageAndgender
names = set()
...
class MainUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("Face Recognizer: Attendance")
...
class PageOne(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        tk.Label(self, text="Enter the name jointly(Name_Surname)", fg="#263942", font='Helvetica 12 bold').grid(row=0, column=0, pady=10, padx=5)
...
class PageThree(tk.Frame):
    ...
    def capimg(self):
        ...
        messagebox.showinfo("INSTRUCTIONS", "We will now Capture 311 pictures of your Face.")
